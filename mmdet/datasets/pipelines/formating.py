...
class DefaultFormatBundle:
    ...
    - gt_visibilities: (1)to tensor, (2)to DataContainer    
    ...
    def __init__(self, img_to_float=True, sensor_keys=['img']):
    ...
    def __call__(self, results):
        ...
        for key in ['proposals', 'gt_bboxes', 'gt_bboxes_ignore', 'gt_labels', 'gt_visibilities']:
